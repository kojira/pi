...
Available built-in tools: `read`, `bash`, `powershell` (Windows), `edit`, `write`, `grep`, `find`, `ls`, and the opt-in `continue_work` continuation checkpoint tool. See [continuation checkpoints](docs/continuation-checkpoints.md).
